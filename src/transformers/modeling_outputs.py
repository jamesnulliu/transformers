...
@dataclass
class BaseModelOutputWithPastAndLayerHiddenStates(ModelOutput):
    """
    ...
    Args:
        last_hidden_state (`list[torch.FloatTensor]` of shape `(n_layers, (batch_size, sequence_length, hidden_size))`):
            Sequence of hidden-states at the output of the last layer of the model.
...
@dataclass
class CausalLMOutputWithPastAndLayerLogits(ModelOutput):
    """
    Base class for causal language model (or autoregressive) outputs with layer logits.
